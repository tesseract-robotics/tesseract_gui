#ifndef TESSERACT_GUI_ADD_ALLOWED_COLLISION_ENTRY_DIALOG_H
#define TESSERACT_GUI_ADD_ALLOWED_COLLISION_ENTRY_DIALOG_H
...
#endif // TESSERACT_GUI_ADD_ALLOWED_COLLISION_ENTRY_DIALOG_H
