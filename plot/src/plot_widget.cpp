...
void PlotWidget::buildActions()
{
  ...
  connect(_action_split_horizontal.get(), &QAction::triggered, this,
  ...
  connect(_action_removeAllCurves.get(), &QAction::triggered, this,
...
void PlotWidget::canvasContextMenuTriggered(const QPoint& pos)
{
  ...
  _action_removeAllCurves->setIcon(LoadSvg(":/tesseract_gui/svg/trash.svg", theme));
  _action_edit->setIcon(LoadSvg(":/tesseract_gui/svg/pencil-edit.svg", theme));
  _action_formula->setIcon(LoadSvg(":/tesseract_gui/svg/Fx.svg", theme));
  _action_split_horizontal->setIcon(LoadSvg(":/tesseract_gui/svg/add_column.svg", theme));
  _action_split_vertical->setIcon(LoadSvg(":/tesseract_gui/svg/add_row.svg", theme));
  _action_zoomOutMaximum->setIcon(LoadSvg(":/tesseract_gui/svg/zoom_max.svg", theme));
  _action_zoomOutHorizontally->setIcon(LoadSvg(":/tesseract_gui/svg/zoom_horizontal.svg", theme));
  _action_zoomOutVertically->setIcon(LoadSvg(":/tesseract_gui/svg/zoom_vertical.svg", theme));
  _action_copy->setIcon(LoadSvg(":/tesseract_gui/svg/copy.svg", theme));
  _action_paste->setIcon(LoadSvg(":/tesseract_gui/svg/paste.svg", theme));
  _action_saveToFile->setIcon(LoadSvg(":/tesseract_gui/svg/save.svg", theme));
  _action_image_to_clipboard->setIcon(LoadSvg(":/tesseract_gui/svg/plot_image.svg", theme));
...
void PlotWidget::overrideCursonMove()
{
  ...
  auto pixmap = LoadSvg(":/tesseract_gui/svg/move_view.svg", theme);
