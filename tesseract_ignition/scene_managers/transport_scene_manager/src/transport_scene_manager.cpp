...
public:
  ...
  std::map<unsigned int, ignition::math::Pose3d> poses;
  ...
  std::map<unsigned int, ignition::math::Pose3d> localPoses;

  /// \brief Map of visual id to visual pointers.
  std::map<unsigned int, ignition::rendering::VisualPtr::weak_type> visuals;

  /// \brief Map of light id to light pointers.
  std::map<unsigned int, ignition::rendering::LightPtr::weak_type> lights;

  /// Entities to be deleted
  std::vector<unsigned int> toDeleteEntities;

  /// \brief Keeps the a list of unprocessed scene messages
  std::vector<ignition::msgs::Scene> sceneMsgs;
...
/////////////////////////////////////////////////
void TransportSceneManagerPrivate::DeleteEntity(unsigned int _entity)
{
