...
/////////////////////////////////////////////////
void GlutRenderer::HandleMouseEvent()
{
  std::lock_guard<std::mutex> lock(this->dataPtr->mutex);
...
/////////////////////////////////////////////////
void GlutRenderer::BroadcastDrop()
{
...
/////////////////////////////////////////////////
void GlutRenderer::BroadcastHoverPos()
{
...
/////////////////////////////////////////////////
void GlutRenderer::BroadcastDrag()
{
...
/////////////////////////////////////////////////
void GlutRenderer::BroadcastLeftClick()
{
  if (!this->dataPtr->mouseDirty)
    return;
...
/////////////////////////////////////////////////
void GlutRenderer::BroadcastRightClick()
{
  if (!this->dataPtr->mouseDirty)
    return;
...
/////////////////////////////////////////////////
void GlutRenderer::BroadcastMousePress()
{
  if (!this->dataPtr->mouseDirty)
    return;
...
/////////////////////////////////////////////////
void GlutRenderer::BroadcastScroll()
{
  if (!this->dataPtr->mouseDirty)
    return;
...
/////////////////////////////////////////////////
void GlutRenderer::BroadcastKeyRelease()
{
...
/////////////////////////////////////////////////
void GlutRenderer::BroadcastKeyPress()
{
...
void GlutRenderWidget::resizeGL(int w, int h)
{
  glViewport(0, 0, w, h);
...
void GlutRenderWidget::paintGL()
{
  ...
  ignerr << "Image, w: " << image.Width() << " h: " << image.Height() << "d: " << image.Depth() << std::endl;
  ...
  QImage qimg;
  qimg.load("/tmp/ign_image.png");
  QImage qimg_convert = qimg.convertToFormat(QImage::Format_RGBA8888);
  doneCurrent();
