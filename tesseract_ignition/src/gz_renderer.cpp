...
//////////////////////////////////////////////////
bool GzRenderer::Initialised() const { return this->initialised; }

//////////////////////////////////////////////////
unsigned int GzRenderer::TextureId() const { return this->textureId; }

//////////////////////////////////////////////////
QSize GzRenderer::TextureSize() const { return this->textureSize; }
...
void GzRenderer::InitEngine()
{
  ...
  {
    ignerr << "Error starting up: " << engineName << std::endl;
  }
