...
{
float vertices[] = {
  -1.0f, -1.0f, 0.0f, 0.0f, -1.0f, 1.0f, 0.0f, 1.0f, 1.0f, -1.0f, 1.0f, 0.0f,
...
void GLWidget::initializeGL()
{
  ...
  char vertexShaderSource[] = "#version 450 core\n"
...
void GLWidget::resizeGL(int w, int h) { m_thread->setNewSize(w, h); }
...
void GLWidget::initRenderThread()
{
  ...
  connect(
      m_thread, &RenderThread::imageReady, this, [this]() { update(); }, Qt::QueuedConnection);
  m_thread->start();
}
