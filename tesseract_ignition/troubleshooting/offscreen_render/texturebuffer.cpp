...
TextureBuffer::TextureBuffer() : m_ready(false), m_texture(0) {}
...
void TextureBuffer::deleteTexture(QOpenGLContext* context) { context->functions()->glDeleteTextures(1, &m_texture); }
