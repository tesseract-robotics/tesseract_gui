 ...
 */
#ifndef TESSERACT_WIDGETS_COMMAND_LANGUAGE_COMPOSITE_INSTRUCTION_MODEL_H
#define TESSERACT_WIDGETS_COMMAND_LANGUAGE_COMPOSITE_INSTRUCTION_MODEL_H
...
#endif  // TESSERACT_WIDGETS_COMMAND_LANGUAGE_COMPOSITE_INSTRUCTION_MODEL_H
