 ...
 */
#ifndef TESSERACT_WIDGETS_COMMAND_LANGUAGE_PLAN_INSTRUCTION_STANDARD_ITEM_H
#define TESSERACT_WIDGETS_COMMAND_LANGUAGE_PLAN_INSTRUCTION_STANDARD_ITEM_H
...
#endif  // TESSERACT_WIDGETS_COMMAND_LANGUAGE_PLAN_INSTRUCTION_STANDARD_ITEM_H
