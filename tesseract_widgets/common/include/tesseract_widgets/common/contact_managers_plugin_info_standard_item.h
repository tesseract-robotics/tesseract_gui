...
#ifndef TESSERACT_WIDGETS_COMMON_CONTACT_MANAGERS_PLUGIN_INFO_STANDARD_ITEM_H
#define TESSERACT_WIDGETS_COMMON_CONTACT_MANAGERS_PLUGIN_INFO_STANDARD_ITEM_H
