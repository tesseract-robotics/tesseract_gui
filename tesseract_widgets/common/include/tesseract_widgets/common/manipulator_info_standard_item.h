 ...
 */
#ifndef TESSERACT_WIDGETS_COMMON_MANIPULATOR_INFO_STANDARD_ITEM_H
#define TESSERACT_WIDGETS_COMMON_MANIPULATOR_INFO_STANDARD_ITEM_H
...
#endif  // TESSERACT_WIDGETS_COMMON_MANIPULATOR_INFO_STANDARD_ITEM_H
