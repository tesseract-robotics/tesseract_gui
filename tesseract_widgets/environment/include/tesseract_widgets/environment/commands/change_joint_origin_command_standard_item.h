 ...
 */
#ifndef TESSERACT_WIDGETS_ENVIRONMENT_CHANGE_JOINT_ORIGIN_COMMAND_STANDARD_ITEM_H
#define TESSERACT_WIDGETS_ENVIRONMENT_CHANGE_JOINT_ORIGIN_COMMAND_STANDARD_ITEM_H
