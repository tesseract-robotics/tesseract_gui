 ...
 */
#ifndef TESSERACT_WIDGETS_ENVIRONMENT_REPLACE_JOINT_COMMAND_STANDARD_ITEM_H
#define TESSERACT_WIDGETS_ENVIRONMENT_REPLACE_JOINT_COMMAND_STANDARD_ITEM_H
...
#endif // TESSERACT_WIDGETS_ENVIRONMENT_REPLACE_JOINT_COMMAND_STANDARD_ITEM_H
