 ...
 */
#ifndef TESSERACT_WIDGETS_PLANNING_TASK_INFO_MAP_STANDARD_ITEM_H
#define TESSERACT_WIDGETS_PLANNING_TASK_INFO_MAP_STANDARD_ITEM_H
...
#endif  // TESSERACT_WIDGETS_PLANNING_TASK_INFO_MAP_STANDARD_ITEM_H
