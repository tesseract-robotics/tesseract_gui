 ...
 */
#ifndef TESSERACT_WIDGETS_PLOT_TRANSFORMS_MOVING_AVERAGE_FILTER_H
#define TESSERACT_WIDGETS_PLOT_TRANSFORMS_MOVING_AVERAGE_FILTER_H

#include <QRadioButton>
#include <QSpinBox>
#include <QDoubleSpinBox>
#include <tesseract_widgets/plot/transform_function.h>
#include <tesseract_widgets/plot/ring_span.h>
