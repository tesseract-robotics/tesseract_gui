#ifndef TESSERACT_GUI_WIDGETS_COMMON_ORIGIN_STANDARD_ITEM_H
#define TESSERACT_GUI_WIDGETS_COMMON_ORIGIN_STANDARD_ITEM_H
...
#endif // TESSERACT_GUI_WIDGETS_COMMON_ORIGIN_STANDARD_ITEM_H
