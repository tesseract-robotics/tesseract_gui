#ifndef TESSERACT_GUI_ENVIRONMENT_COMMAND_STANDARD_ITEM_H
#define TESSERACT_GUI_ENVIRONMENT_COMMAND_STANDARD_ITEM_H
...
#endif // TESSERACT_GUI_ENVIRONMENT_COMMAND_STANDARD_ITEM_H
