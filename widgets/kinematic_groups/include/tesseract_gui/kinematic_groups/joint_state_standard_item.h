#ifndef TESSERACT_GUI_KINEMATIC_GROUP_JOINT_STATE_STANDARD_ITEM_H
#define TESSERACT_GUI_KINEMATIC_GROUP_JOINT_STATE_STANDARD_ITEM_H
...
#endif // TESSERACT_GUI_KINEMATIC_GROUP_JOINT_STATE_STANDARD_ITEM_H
