#ifndef TESSERACT_GUI_WIDGETS_KINEMATICS_GROUP_KINEMATICS_INFO_STANDARD_ITEM_H
#define TESSERACT_GUI_WIDGETS_KINEMATICS_GROUP_KINEMATICS_INFO_STANDARD_ITEM_H
...
#endif // TESSERACT_GUI_WIDGETS_KINEMATICS_GROUP_KINEMATICS_INFO_STANDARD_ITEM_H
