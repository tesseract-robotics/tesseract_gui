 ...
 */
#ifndef TESSERACT_GUI_PLOT_TRANSFORMS_FIRST_DERIVATIVE_H
#define TESSERACT_GUI_PLOT_TRANSFORMS_FIRST_DERIVATIVE_H
...
#endif  // TESSERACT_GUI_PLOT_TRANSFORMS_FIRST_DERIVATIVE_H
