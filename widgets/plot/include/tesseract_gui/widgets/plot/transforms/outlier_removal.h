 ...
 */
#ifndef TESSERACT_GUI_PLOT_TRANSFORMS_OUTLIER_REMOVAL_H
#define TESSERACT_GUI_PLOT_TRANSFORMS_OUTLIER_REMOVAL_H
...
#endif // TESSERACT_GUI_PLOT_TRANSFORMS_OUTLIER_REMOVAL_H
