 ...
 */
#ifndef TESSERACT_GUI_PLOT_TRANSFORMS_SCALE_TRANSFORM_H
#define TESSERACT_GUI_PLOT_TRANSFORMS_SCALE_TRANSFORM_H
...
#endif  // TESSERACT_GUI_PLOT_TRANSFORMS_SCALE_TRANSFORM_H
