#ifndef TESSERACT_GUI_SCENE_GRAPH_OCTREE_STANDARD_ITEM_H
#define TESSERACT_GUI_SCENE_GRAPH_OCTREE_STANDARD_ITEM_H
...
#endif // TESSERACT_GUI_SCENE_GRAPH_OCTREE_STANDARD_ITEM_H
